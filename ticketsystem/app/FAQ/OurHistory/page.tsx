    ...
    return(
        <div className="grid">
            ...
            <div className="text-xl mx-60">
                ...
                and built a reputation for reliability and professionalism.
                Today, we are proud to be a leader in our industry, recognized for our quality service and innovative solutions.
                </p>
            </div>
        </div>
    );
